...
exports.userCalendarEventsRoutesConfig = function (app) {
  app.post('/google-event-webhook', [Audit.logger, googleCalendarEventWebhook]);

  app.get('/bronzeToGoldenById', [Audit.logger, bronzeToGoldenById]);
