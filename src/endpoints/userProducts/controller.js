...
const COLLECTION_NAME = Collections.USER_PRODUCTS;
const INDEXED_FILTERS = ['userId', 'product'];
const PRIMARY_ENTITY_PROPERTY_NAME = 'userId';
const SECONDARY_ENTITY_PROPERTY_NAME = 'product';
const TARGET_COLLECTION_NAME = Collections.PRODUCTS;
