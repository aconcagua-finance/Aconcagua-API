...
exports.userDynamicAttributesRoutesConfig = function (app) {
  ...
  // marca como completo un documento,  el userId es para validacion de permisos del staff
  // app.post('/:userId/:id/complete', [
  //   Audit.logger,
  //   Auth.isAuthenticated,
  //   Auth.isAuthorized({
  //     hasAppRole: [Types.AppRols.APP_ADMIN, Types.AppRols.APP_VIEWER],
