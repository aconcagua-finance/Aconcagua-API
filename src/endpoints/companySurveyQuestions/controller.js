...
const INDEXED_FILTERS = ['companyId', 'surveyId', 'state'];

const COMPANY_ENTITY_PROPERTY_NAME = 'companyId';
const SURVEY_ENTITY_PROPERTY_NAME = 'surveyId';
const COLLECTION_NAME = Collections.COMPANY_SURVEY_QUESTIONS;
...
exports.findByCompany = async function (req, res) {
  ...
  filters.surveyId = { $equal: surveyId };
  ...
  try {
    const result = await listByPropInner({
      ...
      relationships: [
        {
          collectionName: Collections.COMPANY_SURVEYS,
          propertyName: SURVEY_ENTITY_PROPERTY_NAME,
        },
      ],
    });
...
exports.create = async function (req, res) {
  ...
  body.surveyId = req.params.surveyId;
