...
const basicData = {
  originCurrency: Joi.string().min(2).max(100),
  destinyCurrency: Joi.string().min(2).max(100),
  multiplier: Joi.string().min(1).max(10),
...
const requiredBaseFields = ['originCurrency', 'destinyCurrency', 'multiplier'];
